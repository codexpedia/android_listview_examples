...
public class UIHelper {
     ...
     * @param baseHeight The baseHeight to be maintained
     */
    public static void collapse(final View v, final int baseHeight) {
        if (v == null) return;

        final int initialHeight = v.getMeasuredHeight();
        final int collapseAmount = initialHeight - baseHeight;
